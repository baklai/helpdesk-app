...
export const SEMANTIC_COLOR_SCHEMA_LIGHT = {
  primary: {
    color: '{zinc.950}',
    inverseColor: '#ffffff',
    hoverColor: '{zinc.900}',
...
export const SEMANTIC_COLOR_SCHEMA_DARK = {
  primary: {
    color: '{zinc.50}',
...
export const PRIMEVUE_LOCALE_uk_UA = {
  ...
  clear: 'Очистити',
  apply: 'Застосувати',
  matchAll: 'Збігаються всі',
  matchAny: 'Збігається будь-який',
  ...
  fileSizeTypes: ['Б', 'КБ', 'МБ', 'ГБ', 'ТБ', 'ПБ', 'ЕБ', 'ЗБ', 'ЙБ'],
  ...
  fileChosenMessage: 'Обрано файлів: {0}',
  ...
  aria: {
    ...
    star: '1 зірка',
    stars: '{star} зірок',
    selectAll: 'Усі елементи обрано',
    unselectAll: 'Усі елементи скасовано',
    close: 'Закрити',
    previous: 'Попередній',
    next: 'Наступний',
    ...
    jumpToPageDropdownLabel: 'Перехід до сторінки (випадаючий список)',
    jumpToPageInputLabel: 'Перехід до сторінки (ввід)',
    selectRow: 'Рядок обрано',
    unselectRow: 'Рядок не обрано',
