...
<template>
  ...
  >
    ...
    <form class="flex flex-col gap-y-4" @submit.prevent="onSaveRecord">
      <div class="flex flex-col gap-2">
        <label for="name" class="font-bold">Назва організації</label>
        <InputText
          id="name"
          v-model="name"
          v-bind="nameAttrs"
      ...
      <div class="flex flex-col gap-2">
        <label for="address" class="font-bold">Адреса організації</label>
        <InputText
          id="address"
          v-model="address"
          v-bind="addressAttrs"
      ...
      <div class="flex flex-col gap-2">
        <label for="description" class="font-bold">Опис організації</label>
        <Textarea
          id="description"
          rows="5"
          v-model="description"
