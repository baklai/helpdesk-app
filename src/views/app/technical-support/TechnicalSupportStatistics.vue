...
<template>
  <div class="h-full w-full">
    ...
    <div class="flex flex-wrap content-start" style="height: calc(100vh - 9rem)">
      <div class="w-full flex-shrink-0 p-4 lg:w-2/3 xl:w-3/4">
        <div class="flex flex-wrap">
          <div class="w-full flex-shrink-0 p-4 lg:w-2/4 xl:w-1/3">
            <div
              class="mb-6 rounded-lg border border-surface-300 bg-surface-50 p-6 dark:border-surface-600 dark:bg-surface-800"
            >
            ...
            >
              <div class="mb-3 flex justify-between">
                <div>
                  <span class="mb-3 block font-bold"> Загальна кількість закритих запитів </span>
                  <div class="text-xl font-bold text-primary-500">
                    {{ stats?.closed || '-' }}
                  </div>
                </div>
            ...
            >
              <div class="mb-3 flex justify-between">
                <div>
                  <span class="mb-3 block font-bold"> Загальна кількість відкритих запитів </span>
                  <div class="text-xl font-bold text-primary-500">
                    {{ stats?.opened || '-' }}
                  </div>
                </div>
          ...
          <div class="w-full flex-shrink-0 p-4 lg:w-2/4 xl:w-2/3">
            <div
            ...
            >
              <div class="mb-6 flex items-center justify-start gap-2">
                <i class="pi pi-chart-bar mr-2 text-2xl"></i>
      ...
      <div class="w-full flex-shrink-0 p-4 lg:w-1/3 xl:w-1/4">
        <div
          class="mb-6 rounded-lg border border-surface-300 bg-surface-50 p-6 dark:border-surface-600 dark:bg-surface-800"
        >
          <div class="mb-3 flex justify-between">
